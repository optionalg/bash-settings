...
TOOLDIR="/Users/backup/Downloads/2011/android.com/android-sdk-macosx/tools"
if [ -d "${TOOLDIR}" ]; then
	PATH="${TOOLDIR}:${PATH}"
fi

PLATTOOLDIR="/Users/backup/Downloads/2011/android.com/android-sdk-macosx/platform-tools"
